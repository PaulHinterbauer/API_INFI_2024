...
paul_hum_url = 'http://openhabian:8080/rest/items/ZWave_Node_003_Sensor_relative_humidity'
paul_temp_url = 'http://openhabian:8080/rest/items/ZWave_Node_003_Sensor_temperature'
#paul_hum_url='http://192.168.68.112:8080/rest/items/ZWaveNode019WohnzimmerZW100Multisensor6_Sensorrelativehumidity'
#paul_temp_url='http://192.168.68.112:8080/rest/items/ZWaveNode019WohnzimmerZW100Multisensor6_Sensortemperature'

hum_value=requests.get(paul_hum_url)
temp_value=requests.get(paul_temp_url)
...
# CREATE INSERT STATEMENT
    execution_string = f"INSERT INTO sensor_values VALUES ({paul_timestamp}, {act_temp}, {act_hum})"
